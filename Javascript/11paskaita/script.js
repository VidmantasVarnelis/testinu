...
function main() {
	...
	imgEl.alt = 'No image';
	navEl.append(imgEl);
	const listEl = createElement('ul', '', '', navEl);
	// const listExaple = createElement('div', {
	//     className: 'manoklase',
	//     parentNode: navEl
	// })
	createElement('li', 'Home', '', listEl);
	createElement('li', 'About', '', listEl);
	createElement('li', 'Contact Us', '', listEl);
	const iconEl = createElement('i', '', 'fas fa-bars', navEl);
...
function createElement(element, text, classname, parentNode) {
...
// 	if (options.parentNode) parentNode.append(el);
// 	return el;
// }
